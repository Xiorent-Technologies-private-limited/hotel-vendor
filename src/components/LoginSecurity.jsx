      ...
      <div className="max-w-6xl mx-auto bg-white rounded-lg p-4 sm:p-6 space-y-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 text-sm">
          ...
          <div className="space-y-2">
            ...
            <p className="text-gray-400">Not chosen</p>
            <p className="text-gray-400">Not chosen</p>
            <p className="text-gray-400">Not chosen</p>
          </div>
          ...
          <div className="space-y-2">
            ...
            <p className="text-red-600">@Tusharsha</p>
            <p className="text-blue-600">facebook.com/tusharsha</p>
            <p className="text-pink-500">@Tusharsha</p>
        ...
        <div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 text-sm">
            ...
            <div className="space-y-2">
              <p className="font-medium text-gray-800">Tusharsha@gmail.com</p>
              <button
              ...
              <p className="font-medium text-gray-800 mt-3">+91 9875476803</p>
        ...
        <div className="space-y-3">
          ...
          <div className="space-y-2 text-sm">
            ...
            <div>
              <p className="font-medium text-gray-800">iPhone 11 • New Delhi, India</p>
